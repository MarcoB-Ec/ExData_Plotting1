...
with(df, plot(DaTime, Global_active_power, type = "l", 
              ylab = "Global Active Power (kilowats)"))

with(df, plot(DaTime,Voltage,type = "l", 
...
legend("topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
       col = c("black", "red", "blue"),pch = "_", cex = 0.50)

with(df, plot(DaTime, Global_reactive_power, type = "l", xlab = "datetime"))
